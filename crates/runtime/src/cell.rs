...
//! Pointer-like tags (REF/STR/LST/FLT) carry **heap cell indices**, not
//! raw pointers — the heap is a growable `Vec<u64>` and indices stay
//! valid across reallocation (and across backtracking truncation).
